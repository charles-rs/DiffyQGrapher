...
/**
 * Class to represent one whole derivative. Example: dy/dt = x^2 - a t + 4
 */
public class Derivative extends Node {
    ...
    public boolean equals(Object other) {
        if (other instanceof Derivative) {
            return this.diff.equals(((Derivative) other).diff)
                    && this.val.equals(((Derivative) other).val);
        } else
            return false;
    }
