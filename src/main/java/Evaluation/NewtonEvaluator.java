...
{
	/**
	 * does one step of newtons method with the initial information
	 * @param start the starting point
	 * @param a the a val
	 * @param b the b val
	 * @param t the t val
	 * @param dx the first equation
	 * @param dy the second equation
	 * @param fst the first variable
	 * @param scd the second variable
	 * @return the next point generated by Newton's method
	 * @throws RootNotFound if something goes wrong (derivative is singular or equations have syntax errors)
	 */
	...
	/**
	 * Solves a system of two equations using Newton's method
	 * @param iterations the maximum number of iterations to do
	 ...
	 * @throws RootNotFound when Newton's method fails to converge after the given max number of iterations, or something
