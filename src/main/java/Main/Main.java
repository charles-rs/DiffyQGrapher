...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        draw.getItems().addAll(separatrices, horizIso, vertIso, new SeparatorMenuItem(), pentagram,
                noMorePentagram, editPentagram, new SeparatorMenuItem(), limCycle, basin, coBasin);
        ...
        outPlane.progressBarBox = progressBarBox;
        InputPlane inPlane =
                new InputPlane(300, aField, bField, outPlane, settings.inPlaneSettings);
        outPlane.in = inPlane;
        ...
        leftBox.getChildren().addAll(inPlane, inPButtonBox, progressBarBox);
        ...
        saveInpt.setOnAction(e -> {
            ...
            chooser.getExtensionFilters()
                    .add(new FileChooser.ExtensionFilter("PNG Images", "*.png"));
    ...
    private void openSecondary(Derivative n, char var, double a, double b, double x, double y,
        ...
        DerivativeGraph graph =
                new DerivativeGraph(300, n, var, a, b, x, y, t, xInput, yInput, tInput);
        HBox xBox = new HBox();
        HBox yBox = new HBox();
        HBox tBox = new HBox();
    ...
    /**
     * Opens a new window to get new bounds for saddle connections from the user. If there are
     * number errors, ignores them and leaves that value unchanged.
     */
    private void getSaddleBoundsAndSet() {
        ...
        mainV.setSpacing(8);
        mainV.getChildren().addAll(xMinBox, new Separator(), xMaxBox, new Separator(), yMinBox,
                new Separator(), yMaxBox);
